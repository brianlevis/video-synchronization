...
from peak import local_envelope_peaks, librosa_peaks
...
synchronize_video('club/club.wav', 'spot/spot.mp4', 'spot_in_da_club.mp4')
# synchronize_video('red/red.wav', 'car/car.mp4', 'smol_beat_test2.mp4')
# combine_videos(
